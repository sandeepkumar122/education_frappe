...
frappe.listview_settings['Student Applicant'] = {
	...
	get_indicator: function(doc) {
		...
		else if(doc.application_status=="In-Merit"){
			return [__("In-Merit"), "yellow", "application_status,=,In-Merit"];
		}
		else if(doc.application_status=="Not Eligible"){
			return [__("Not Eligible"), "maroon", "application_status,=,Not Eligible"];
		}
	}
};
